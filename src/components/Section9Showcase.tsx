...
/**
 * Skiper 17 (StickyCard002) — Exact 1:1 Copy from Skiper UI
 * https://skiper-ui.com/v1/skiper17
 * Built with GSAP ScrollTrigger + Lenis smooth scroll.
...
export default function Section9Showcase({
  ...
  useGSAP(
    () => {
      ...
      // Initial states: Card 0 is visible at y:0, all others start below at y:100%
